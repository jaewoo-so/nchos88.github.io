...
## 모델
Imbalance 데이터에는 Bagging 및 Boosting 기반의 알고리즘이 잘 동작한다고 알려져 있고 많이 사용하는 방법입니다[5,6,7]. 따라서 Bagging 방식의 Random Forest , Boosting방식의 XGBoost , Neural Network 을 가지고 실험 해 보았습니다.  
각각의 모델 파라미터는 다음과 같습니다. 


<p align = "center">
<img src = "https://github.com/nchos88/DataContainer/blob/master/RNA_MTL/model_params.png?raw=true" width = "400" height = "250">
</p>



## 검증방법 
class imbalance인 데이터이기 때문에 일반적인 accuracy로는 적은 샘플의 클래스에 대한 성능 측정이 어렵기 때문에, 주 성능 지표로는 aucPR( Area Under the Precision-Recall Curve )를 사용했습니다. 
...
<p align = "center">
<img src = "https://github.com/nchos88/DataContainer/blob/master/RNA_MTL/nn_rf.png?raw=true" width = "800" height = "400">
</p>



여기서 재미있는 부분은 암종 중에 RNA또는 메틸레이션에 중요한 정보가 치우쳐서 있는 것들을 발견했습니다. 예시로 샘플수 3000개인 Random Foreset 모델의 예측 결과에 대한 Confusion Matrix를 살펴 보겠습니다. 

메틸레이션만 사용한 데이터, 즉 RNA데이터를 사용하지 않았을 경우 STES를 HNSC로 잘못 예측하는 경우가 늘어납니다. 반대로 RNA만 사용한 데이터, 즉 메틸레이션 데이터를 사용하지 않았을 경우 UCS를 SARC로 잘못 예측하는 경우가 늘어납니다. 따라서 암종 중에 메틸레이션이나 RNA중 한가지에 치우친 고유한 패턴을 가진 암종이 있을 거란 가능성이 높다고 유추해 볼 수 있었습니다. 
...
---
<p align = "center">
<b>중요도 top50 RNA+메틸레이션 , RNA , 메틸레이션 lgbm</b>
</p>
<p align = "center">
...
##
<p align = "center">
<b>중요도 top50 RNA+메틸레이션 , RNA , 메틸레이션 xgb</b>
</p>
<p align = "center">
